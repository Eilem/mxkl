...
let filmesSessao2 = [
    {
        ...
        link: "https://www.looke.com.br/filmes/acordar-do-dia",
    },
    {
        id : "sessao_2_2",
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <img class="img-fluid rounded mb-3" src="${prefixPathSessao2}${filmeAtual.imagem}" alt="${filmeAtual.titulo}" title="${filmeAtual.titulo}" />
