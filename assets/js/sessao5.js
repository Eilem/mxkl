                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <img class="img-fluid rounded mb-5" src="${prefixPathSessao5}${filmeAtual.imagem}" alt="${filmeAtual.titulo}" title="${filmeAtual.titulo}" />
                                        ...
                                        <p class="text-reference mt-3"> ${filmeAtual.dados} </p>
